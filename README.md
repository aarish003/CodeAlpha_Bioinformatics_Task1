# CodeAlpha_Bioinformatics_Task1
CodeAlpha Bioinformatics Internship Task 1 - Protein Sequence Analysis using BLAST

This repository contains the work completed for Task 1: DNA/Protein Sequence Analysis
as part of the CodeAlpha Bioinformatics Internship Program

Objective
-To analyze a protein sequence using NCBI BLAST and identify homologous sequences.
...
Methodology
1. Downloaded protein sequence from UniProt in FASTA format.
2. Performed BLASTp analysis using NCBI BLAST.
